...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-661-erd-s-problem-661-043e5aa6-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-661"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-661-erd-s-problem-661-043e5aa6-v1",
      "problem_contract_sha256": "ab55bef2e2714bd8f0901fe9e608aecde0ab7396d1b65278c5e58bf5f1f2dcd5",
      "problem_id": "problem:um-ep-661-erd-s-problem-661-043e5aa6",
      "route_id": "route:um-ep-661-erd-s-problem-661-043e5aa6-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-661-erd-s-problem-661-043e5aa6-source-fidelity-01",
      "graph_id": "graph:um-ep-661-erd-s-problem-661-043e5aa6-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-661-erd-s-problem-661-043e5aa6-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-661-erd-s-problem-661-043e5aa6-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are there, for all large $n$, some points $x_1,\\ldots,x_n,y_1,\\ldots,y_n\\in \\mathbb{R}^2$ such that the number of distinct distances $d(x_i,y_j)$ is $ o\\left(\\frac{n}{\\sqrt{\\log n}}\\right)? $"
          },
          "statement_sha256": "a8c6220affc2c5fa446e59a05c54db2a4e0bbd3b1803e8a5cd64e7190bd677f5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-661-erd-s-problem-661-043e5aa6-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-661-erd-s-problem-661-043e5aa6-root",
      "route_id": "route:um-ep-661-erd-s-problem-661-043e5aa6-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-661-ec2b70eae308",
        "url": "https://www.unsolvedmath.com/problems/EP-661"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
